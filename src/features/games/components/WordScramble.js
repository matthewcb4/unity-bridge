...
const WordScramble = ({
    ...
    const isFamilyGame = !!game.targetScore;
    const myId = role;
            ...
            {isFamilyGame && (
                <div className="grid grid-cols-2 gap-2 text-center">
                    <div className="bg-purple-50 p-2 rounded-xl">
                        ...
                        <p className="text-2xl font-black text-purple-600">{game.players?.[myId]?.score || 0}</p>
                    </div>
                    ...
                    <p className="col-span-2 text-[9px] text-slate-400">First to {game.targetScore} points wins!</p>
                </div>
            )}
