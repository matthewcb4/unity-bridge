                    ...
                    {view === 'games' && (
                        <div className="p-4 space-y-4 animate-in slide-in-from-bottom-4">
                            ...
                            {(() => {
                                ...
                                if (activeGame) {
                                    return (
                                        <div className="bg-white rounded-2xl shadow-xl border border-purple-100 p-3 space-y-2">
                                                                ...
                                                                {displayBoard.map((cell, i) => {
                                                                    ...
                                                                    return (
                                                                        <div
                                                                            ...
                                                                            className={`w-7 h-7 flex items-center justify-center text-[10px] font-bold rounded-[2px] transition-all relative
                                                                                ${cell
