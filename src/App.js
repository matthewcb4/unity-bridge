                        ...
                        <div className="p-4 space-y-4 animate-in slide-in-from-bottom-4">
                            ...
                            <div className="bg-white rounded-[2.5rem] shadow-xl border border-purple-100 p-6 space-y-4">
                                ...
                                {(() => {
                                    ...
                                    const hisPoints = filteredHistory.filter(g => g.solvedBy === 'his').reduce((sum, g) => sum + (g.points || 10), 0);
                                    const hersPoints = filteredHistory.filter(g => g.solvedBy === 'hers').reduce((sum, g) => sum + (g.points || 10), 0);

                                    return (
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="text-center p-4 bg-blue-50 rounded-2xl">
                                                <p className="text-[10px] font-bold text-blue-500 uppercase">{husbandName || 'Him'}</p>
                                                <p className="text-3xl font-black text-blue-600">{hisPoints}</p>
                                            ...
                                            <div className="text-center p-4 bg-rose-50 rounded-2xl">
                                                ...
                                                <p className="text-3xl font-black text-rose-600">{hersPoints}</p>
